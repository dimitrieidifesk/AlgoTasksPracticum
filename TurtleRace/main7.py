...
def init_turtles(num_turtles, target_point):
    ...
    for _ in range(num_territories):
        while True:
            territory_width = random.randint(min_width, screen_width // 2)
            territory_height = random.randint(min_height, screen_height // 2)
            xmin = random.randint(-screen_width // 2, screen_width // 2 - territory_width)
            ymin = random.randint(-screen_height // 2, screen_height // 2 - territory_height)
            xmax = xmin + territory_width
            ymax = ymin + territory_height
